...
UPDATE nyc_sep SET Total_amount = Total_amount/10
UPDATE nyc_sep SET Total_amount = Total_amount/10 WHERE Total_amount > 100
UPDATE nyc_sep SET Fare_amount = Total_amount/10
UPDATE nyc_sep SET Fare_amount = Total_amount/10 WHERE Fare_amount > 100
UPDATE nyc_sep SET Tip_amount = Total_amount/10
UPDATE nyc_sep SET Tip_amount = Total_amount/10 WHERE Tip_amount > 100
UPDATE nyc_sep SET Tolls_amount = Total_amount/10
UPDATE nyc_sep SET Tolls_amount = Total_amount/10 WHERE Tolls_amount > 100

UPDATE nyc_oct SET Total_amount = Total_amount/10
UPDATE nyc_oct SET Total_amount = Total_amount/10 WHERE Total_amount > 100
UPDATE nyc_oct SET Fare_amount = Total_amount/10
UPDATE nyc_oct SET Fare_amount = Total_amount/10 WHERE Fare_amount > 100
UPDATE nyc_oct SET Tip_amount = Total_amount/10
UPDATE nyc_oct SET Tip_amount = Total_amount/10 WHERE Tip_amount > 100
UPDATE nyc_oct SET Tolls_amount = Total_amount/10
UPDATE nyc_oct SET Tolls_amount = Total_amount/10 WHERE Tolls_amount > 100
